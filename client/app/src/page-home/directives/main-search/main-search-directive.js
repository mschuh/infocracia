(function(){
    ...
    angular.module('app.pageHome').directive('plMainSearch',plMainSearch); 

    plMainSearch.$inject = ["$q", "$timeout"];   
 
    function plMainSearch($q, $timeout) {
	return {
	    ...
	    templateUrl: './src/page-home/directives/main-search/main-search-directive.html'
	};
    }
})();
